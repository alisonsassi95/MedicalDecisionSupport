...
Esse programa tem o objetivo criar um arquivo csv para utilizá-lo futuramente no projeto.
A geração desses dados são validados por um profissional da saúde envolvido no projeto.
...
Dados Pessoais			Previsão de sobrevivência a curto prazo						Previsão de sobrevivência a longo prazo		Desempate	
PACIENTE			SOFA						Índice Comorbidades	Eastern Cooperative Oncology Group		
Paciente	idade	sexo	NEUROLÓGICO	CARDIOVASCULAR	RESPIRATÓRIO	COAGULAÇÃO	HEPÁTICO	RENAL	ICC	ECOG	Menor SOFA	Julgamento Clínico
...
# Ler o arquivo "nome" coluna 2 para preencher a coluna sexo;

# ------------------------------------------------------------------

# Parte do CSV: Previsão de sobrevivência a curto prazo					
# Gerar dados entre 0 e 4 para preencher a coluna NEUROLÓGICO;
# Gerar dados entre 0 e 4 para preencher a coluna CARDIOVASCULAR;
# Gerar dados entre 0 e 4 para preencher a coluna RESPIRATÓRIO;
# Gerar dados entre 0 e 4 para preencher a coluna COAGULAÇÃO;
# Gerar dados entre 0 e 4 para preencher a coluna HEPÁTICO;
...
#1 - Criar um arquivo CSV com as colunas e registros fixos;
#2 - Buscar o nome no outro CSV e colocar na coluna 1......
